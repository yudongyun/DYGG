...
// main 메소드를 보유하고 있는 클래스일때 main을 붙힘 ( 실행의 주체가 됨 )
public class NextMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(junho); // 이상하게 나옴
		...
		// 생성자의 파라미터 순서에 유의해서 필드 변수에 값을 넣는다
		...
		// syso 내에 객체를 넣게 되면, toString()의 실행 결과가 출력
		...
		NextStudent chanung = new NextStudent("찬웅", 30, 1, 0);
		System.out.println(chanung);
		
		NextStudent chanungssam = new NextStudent("찬웅쌤", 40, 1, 0);
		System.out.println(chanungssam);
