...
public class codingdy {
	...
	public void study() throws InterruptedException {
		...
		System.out.println("       ↓      ");
		System.out.println("찬웅쌤 : 이런 천재는 오랜만이군 ..");
		Thread.sleep(1500);
		System.out.println("java 공부가 끝났다.");
		System.out.println("java를 공부하고 변화가 생겼습니다.");
		System.out.println("      ↓      ");
		codinglevel++;
	...
	public void party() throws InterruptedException {
		...
		System.out.println("🍺▶◀▶◀▶◀▶◀▶◀▶◀▶◀▶◀▶◀▶◀▶◀▶◀▶◀ ");
		Thread.sleep(400);
		System.out.println("🍺술을 마시고 변화가 생겼습니다. ");
		System.out.println("             ↓      ");
		codinglevel -= 1;
	...
	public boolean unhappy() {
		if(happiness <= 0) {
			System.out.println("당신은 더 이상 행복하지 않습니다..");
			System.out.println("☠☠☠GAME OVER☠☠☠");
			System.out.println(". ∧_∧ 다음엔 잘될거야\n" + 
					"( ´･ω･)∧∧\n" + 
					"./⌒ ,つ⌒ヽ)\n" + 
	...
	public boolean codingmaster() {
		if(codinglevel >= 10) {
			System.out.println("당신은 정식 개발자가 되었습니다.");
	...
	public boolean nocodingmaster() {
		if(codinglevel <= 0) {
			System.out.println("당신은 개발자를 포기했습니다.");
			System.out.println("☠☠☠GAME OVER☠☠☠");
			System.out.println(". ∧_∧ 다음엔 잘될거야\n" + 
					"( ´･ω･)∧∧\n" + 
					"./⌒ ,つ⌒ヽ)\n" + 
	...
	public String toString() {
		return "▶▶ 이름 : " + name + ", 나이 : " + age + ", 코딩실력 : " + codinglevel + ", 자신감 : " + confidence
