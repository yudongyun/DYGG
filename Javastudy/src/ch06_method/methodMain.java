...
public class methodMain {
	...
	public static void main(String[] args) {
		...
		// 해당 코드를 한 곳에서 관리할 수 있기 때문에 수정할때 용이
		...
		// System.out.println(); 를 print()로 만들어서 써보자
		print("파이썬 저리가라~");
...
//		System.out.println(sum);
		...
		System.out.println("\n====================\n");
		// LoopWhile 에서 했던 포켓몬스터도 메소드로 만들기
//		playPokemon();
	...
	public static void recurtionPrint(int num) {
		// 재귀함수도 반복을 중단하는 조건을 잘 설정해야 한다.
		if(num <= 0) {
			return;
		}
		
		System.out.println(num);
		recurtionPrint(num - 1);
...
//		}
	...
	/**
	 * 입력한 소수를 반올림하여 소수 n번째 자리로 리턴해주는 함수 입니다.
	 * @param num 반올림하고자하는 소수
	...
	public static void makeCard(String name, int guk, int eng, int math) {
		...
		double avg = (guk + eng + math) / 3.0;
		
		// 반올림
		// 89.6666 -> 90이 되어버림
		// 89.67
		double score = weRound(avg, 7);
